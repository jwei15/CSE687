...
namespace MessagePassingComm
{
    ...
    public class Sender
    {
        ...
        public Sender(string baseAddress, int listenPort)
        {
            ...
            //Console.Write("\nGoing to createSendChannel\n");
            //createSendChannel("http//:localhost:8080/IMessagePassingComm");
        }
        /*----< creates proxy with interface of remote instance >------*/

        public void createSendChannel(string address)
        {
            //Console.Write("In createSendChanel\n");
        ...
        public bool postFile(string fileName)
        {
            ...
            try
            {
                ...
                if (channel == null) { Console.Write("\nNo channel ready to run\n"); }
                channel.openFileForWrite(path);
    ...
    public class Comm
    {
        ...
        {
            address = baseAddress + ":" + port.ToString();
            portNum = port;
            rcvr = new Receiver();
    ...
    class TestPCommService
    {
        ...
        public static List<string> getClientFileList()
        {
            ...
            string[] files = Directory.GetFiles("../../../ClientFiles");
